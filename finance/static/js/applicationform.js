...
// title name
var title =  ['Mr.','Ms.','Miss.','Mrs.'];
var titleOption = "";
for(var i = 0; i < title.length; i++)
{
    titleOption += '<option value ="'+ title[i] + '">' + title[i] + "</option>"
}
document.getElementById('title').innerHTML = titleOption;
...
{
	genderOption += '<option value ="'+gender[i]+'">'+gender[i]+"</option>"
}
document.getElementById('gender').innerHTML = genderOption;

// marital

var marital = ['Marrital Status','Married','Single','Widowed','Divorced'];
var maritalOption = "";
for(var i = 0; i < marital.length; i++)
{
	maritalOption += '<option value ="'+marital[i]+'">'+marital[i]+"</option>"
}
document.getElementById('marital').innerHTML = maritalOption;

// Application

var application = ['Application','Credit Card','Home Loan','Personal Loan','Car Loan','Business Loan','Education Loan'];
var applicationOption = "";
for(var i = 0; i < application.length; i++)
{
	applicationOption += '<option value ="'+application[i]+'">'+application[i]+"</option>"
}
document.getElementById('application').innerHTML = applicationOption;

// Gross Monthly Income

var grossmonthly = ['ex 10k','10k to 30k','30k to 100k','100k more'];
var grossmonthlyOption = "";
for(var i = 0; i < grossmonthly.length; i++)
{
	grossmonthlyOption += '<option value ="'+grossmonthly[i]+'">'+grossmonthly[i]+"</option>"
}
document.getElementById('grossmonthly').innerHTML = grossmonthlyOption;

// Form Application Validation

function validateApplication()
{
	var name = document.applicationForm.fname.value;
	var last = document.applicationForm.flast.value;
	var appgender = document.applicationForm.fgender.value;
	var appNumber = document.applicationForm.fnumber.value;
	var userEmail = document.applicationForm.femail.value;
	var app_marital = document.applicationForm.fmarital.value;
	var pancard = document.applicationForm.fpan.value;
	var aadhar = document.applicationForm.faadhar.value;
	var useraddress = document.applicationForm.faddress.value;
	var postel = document.applicationForm.fpostel.value;
	var stateError = document.applicationForm.fcity.value;
	var cityError = document.applicationForm.fcityName.value;
	var Gross = document.applicationForm.fgross.value;
	var application_purp = document.applicationForm.fApplicationpurpose.value;
	var occupation = document.applicationForm.foccupation.value;
	...
	if(appgender == gender[0] || appgender == "")
	{
		document.getElementById('appGender').innerHTML = "*";
		flag = 0;
	}
	else
	{
	...
	if(app_marital == marital[0] || app_marital == "")
	{
		document.getElementById('marritalStatus').innerHTML = "*";
		flag = 0;
	}
	else
	{
	...
	{
		document.getElementById('addharNum').innerHTML = "";
		flag = 1;
	}
	...
	if(stateError == state_arr[0] || stateError == "")
	{
		document.getElementById('app_state').innerHTML = "*";
		flag = 0;
	}
	else
	{
	...
	if(application_purp == application[0] || application_purp == "")
	{
		document.getElementById('application_pur').innerHTML = "*";
		flag = 0;
	}
	else
	{
	...
	{
		document.getElementById('app_occupation').innerHTML = "*";
		flag = 0;
	}
	else
	{
